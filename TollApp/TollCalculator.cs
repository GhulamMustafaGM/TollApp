...
namespace TollApp
{
    public class TollCalculator
    {
        ...
        public int GetTollFee(Vehicle vehicle, DateTime[] dates)
        {
            ...
            {
                // Log files exception if occured in database.
                logger.Info("Exception in GetAadharDetails Method. Exception is " + ex.Message);
                throw ex;
            }
        }

        // No need of this method. we have created a method in vehicle interface to set the boolen value direct in the relevant class. For example see class car or motorbike
        ...
        {
            // No need to use this here. we have used this code in other GetTollFee method 
        ...
        // No need private enum TollFreeVehciles here anymore 
